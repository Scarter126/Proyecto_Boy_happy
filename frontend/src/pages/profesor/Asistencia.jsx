/**
 * Asistencia Page - Profesor
 *
 * Simplified daily attendance management for teachers.
 * Single source of truth: alumnos list (filtered by profesor's courses)
 */
...
function Asistencia() {
  ...
  // Debug logging
  useEffect(() => {
    console.log('[Asistencia Profesor] Data loaded:', {
      ...
      {!isLoading && alumnosConAsistencia.length === 0 && (
        <EmptyStateCard
          ...
          description={cursoFilter
            ...
            : "No hay alumnos en tus cursos asignados."}
          iconColor="#667eea"
        />
      )}
