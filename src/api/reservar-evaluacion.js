...
exports.handler = async (event) => {
  ...
  if (event.httpMethod === 'POST') {
    ...
    const { tipo, fechaHora, nombreAlumno, rutAlumno, fechaNacimiento, telefono, correo, nombreApoderado, rutApoderado } = data;
    ...
    if (!esBloqueo && (!nombreAlumno || !rutAlumno || !fechaNacimiento || !telefono || !correo || !nombreApoderado || !rutApoderado)) {
