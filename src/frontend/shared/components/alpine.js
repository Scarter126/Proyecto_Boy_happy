/**
 * Alpine Components - Componentes Reutilizables con Alpine.js
 *
 * Responsabilidad ÚNICA:
 * - Componentes Alpine.data() reutilizables
 * - DataTables, Forms, Tabs, Modals, etc.
 *
 * Requiere:
 * - Alpine.js
 * - components/ui.js (para Modal, Notify)
...
document.addEventListener('alpine:init', () => {
  ...
  // ⚠️ DEPRECATED - Ahora se usa dashboard-app.js modular
  // ==========================================
  /* COMENTADO - Usar dashboard-app.js en su lugar
